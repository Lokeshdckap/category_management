...
class CustomerAuthController extends Controller
{
    ...
    public function login(Request $request): JsonResponse
    {
        ...
        $customer = Customer::with('customerGroup')->where('email', $request->email)->first();
        ...
        if (!$customer->status || is_null($customer->customer_group_id)) {
            return response()->json([
                'success' => false,
        ...
        if (!$customer->status || !$group || !$group->status) {
            return response()->json([
                'success' => false,
